...
try:
    ...
    Orgullo_y_prejuicio = libro ('001G', 'Orgullo y prejuicio', 45000, 'Una historia de amor y sociedad en la Inglaterra del siglo XIX', 'Jane Austen', '978-8497942363')
    El_Alquimista = libro ('001H', 'El Alquimista', 48000, 'Relata el viaje de Santiago en busca de su leyenda personal', 'Paulo Coelho', '978-0062315007')
    Don_Quijote_de_la_Mancha = libro ('001I', 'Don Quijote de la Mancha', 55000, 'Las aventuras del ingenioso hidalgo Don Quijote y su fiel escudero Sancho Panza', 'Miguel de Cervantes', '978-8420452935')
    Crimen_y_castigo = libro ('001J', 'Crimen y castigo', 52000, 'Un estudiante comete un asesinato y enfrenta las consecuencias morales y psicológicas', 'Fyodor Dostoevsky', '978-0143058142')
    Moby_Dick = ('001K', 'Moby Dick', 59000, 'Un capitán obsesionado con cazar a la ballena blanca, Moby Dick', 'Herman Melville', '978-8445071404')
    Los_miserables = ('001L', 'Los miserables', 54000, 'La historia de Jean Valjean y su lucha por la redención en la Francia del siglo XIX', 'Victor Hugo', '978-8423342698')
    ...
    El_principito = ('001T', 'El Principito', 35000, 'Una narración poética sobre la amistad y la búsqueda de sentido en la vida', 'Antoine de Saint-Exupéry', '978-0307476121')
